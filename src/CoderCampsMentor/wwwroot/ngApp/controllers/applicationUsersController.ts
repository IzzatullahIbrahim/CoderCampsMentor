namespace CoderCampsMentor.Controllers {
    ...
    export class MyProfileController {
        ...
        constructor(private $stateParams: ng.ui.IStateParamsService, private $http: ng.IHttpService, private profileService: CoderCampsMentor.Services.ProfileService) {
